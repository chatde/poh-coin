      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              <div className="w-10 h-10 rounded-full bg-charity-green/20 flex items-center justify-center mb-4">
                <span className="text-charity-green font-bold">
                  {item.step}
                </span>
              </div>
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-2 text-foreground/70">
          <li className="flex gap-3">
            <span className="text-charity-green">&#10003;</span>
